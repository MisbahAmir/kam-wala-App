            ...
            child: SizedBox(
              ...
              child: Stack(
                ...
                children: [
                    ...
                    return TweenAnimationBuilder<double>(
                      ...
                      builder: (context, scale, child) {
                        return Transform.scale(
                          scale: scale,
                          child: Container(
                            width: 240 - (i * 70).toDouble(),
                            height: 240 - (i * 70).toDouble(),
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              gradient: RadialGradient(
                                colors: [
                  ...
                  // Rotating glowing sweep line with trail
                  TweenAnimationBuilder(
                    tween: Tween<double>(begin: 0, end: 6.28), // 0–360°
